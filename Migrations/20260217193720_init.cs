        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyTokensUsed = table.Column<int>(type: "int", nullable: false),
                    MonthlyTokensUsed = table.Column<int>(type: "int", nullable: false),
                    RequestsPerMinuteLimit = table.Column<int>(type: "int", nullable: false),
                    CurrentMinuteRequests = table.Column<int>(type: "int", nullable: false),
                    ...
                    MinuteResetAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageQuotas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonProgresses_AspNetUsers_StudentUserId",
                        column: x => x.StudentUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIRequestLog_CreatedAt",
                table: "AIRequestLogs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequestLog_UserId",
                table: "AIRequestLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRequestLog_UserId_CreatedAt",
                table: "AIRequestLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollment_StudentCourse",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_StudentLesson",
